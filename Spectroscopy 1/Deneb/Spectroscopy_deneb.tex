...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{spectrum\PYZus{}filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{deneb\PYZus{}3s\PYZus{}1.bmp}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
(array([[39, 45, 49, {\ldots}, 58, 29, 29],
        [37, 26, 48, {\ldots}, 40, 31, 25],
        [44, 68, 26, {\ldots}, 28, 34, 33],
        {\ldots},
        [40, 21, 25, {\ldots}, 28, 27, 32],
        [38, 31, 24, {\ldots}, 26, 47, 46],
        [34, 43, 27, {\ldots}, 26, 46, 32]], shape=(1200, 1600), dtype=uint8),
 (1200, 1600))
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{bad\PYZus{}pixels} \PY{o}{=} \PY{p}{(}\PY{n}{yvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{480}\PY{p}{)} \PY{o}{|} \PY{p}{(}\PY{n}{yvals} \PY{o}{\PYZgt{}} \PY{l+m+mi}{500}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{bad\PYZus{}pixels} \PY{o}{=} \PY{p}{(}\PY{n}{yvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{475}\PY{p}{)} \PY{o}{|} \PY{p}{(}\PY{n}{yvals} \PY{o}{\PYZgt{}} \PY{l+m+mi}{500}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{[}\PY{l+m+mi}{475}\PY{p}{:}\PY{l+m+mi}{500}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
...
\PY{n}{yaxis} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{repeat}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{475}\PY{p}{,} \PY{l+m+mi}{500}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{k+kc}{None}\PY{p}{]}\PY{p}{,}
...
\PY{n}{weighted\PYZus{}yaxis\PYZus{}values} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{average}\PY{p}{(}\PY{n}{yaxis}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,}
                                   \PY{n}{weights}\PY{o}{=}\PY{n}{image\PYZus{}array}\PY{p}{[}\PY{l+m+mi}{475}\PY{p}{:}\PY{l+m+mi}{500}\PY{p}{,}\PY{p}{:}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{background}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{[}\PY{l+m+mi}{475}\PY{p}{:}\PY{l+m+mi}{500}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,}
          \PY{n}{extent}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{image\PYZus{}array}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{475}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{]}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1600}\PY{p}{,}\PY{l+m+mi}{475}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
(np.float64(0.0), np.float64(1600.0), np.float64(475.0), np.float64(500.0))
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{bad\PYZus{}moments} \PY{o}{=} \PY{p}{(}\PY{n}{weighted\PYZus{}yaxis\PYZus{}values} \PY{o}{\PYZgt{}} \PY{l+m+mi}{495}\PY{p}{)} \PY{o}{|} \PY{p}{(}\PY{n}{weighted\PYZus{}yaxis\PYZus{}values} \PY{o}{\PYZlt{}} \PY{l+m+mi}{485}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Polynomial1D(2, c0=496.57481397, c1=-0.01681492, c2=0.00000666)>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Polynomial1D(3, c0=495.02855436, c1=-0.00600724, c2=-0.00000983,
c3=0.00000001)>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{[}\PY{l+m+mi}{475}\PY{p}{:}\PY{l+m+mi}{500}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{extent}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{image\PYZus{}array}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{475}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{]}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{gca}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{set\PYZus{}aspect}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1600}\PY{p}{,}\PY{l+m+mi}{475}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{)}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{polymodel} \PY{o}{=} \PY{n}{Polynomial1D}\PY{p}{(}\PY{n}{degree}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{)}
\PY{n}{fitted\PYZus{}polymodel} \PY{o}{=} \PY{n}{linfitter}\PY{p}{(}\PY{n}{polymodel}\PY{p}{,} \PY{n}{xvals}\PY{p}{[}\PY{p}{(}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{1200}\PY{p}{)}\PY{p}{]}\PY{p}{,}
                             \PY{n}{weighted\PYZus{}yaxis\PYZus{}values}\PY{p}{[}\PY{p}{(}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{1200}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\PY{n}{fitted\PYZus{}polymodel}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Polynomial1D(3, c0=494.65366662, c1=-0.00247199, c2=-0.00001697,
c3=0.00000001)>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xvals}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]}\PY{p}{,}
        \PY{n}{weighted\PYZus{}yaxis\PYZus{}values}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{fitted\PYZus{}polymodel}\PY{p}{(}\PY{n}{xvals}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZlt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{x}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xvals}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZgt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]}\PY{p}{,}
        \PY{n}{weighted\PYZus{}yaxis\PYZus{}values}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZgt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{fitted\PYZus{}polymodel}\PY{p}{(}\PY{n}{xvals}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{bad\PYZus{}moments} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{xvals} \PY{o}{\PYZgt{}} \PY{l+m+mi}{1300}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r+}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
...
\PY{n}{ax1}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{[}\PY{l+m+mi}{475}\PY{p}{:}\PY{l+m+mi}{500}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{extent}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{image\PYZus{}array}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{475}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{]}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Gaussian1D(amplitude=171.54709267, mean=0.84944266, stddev=4.88927717)>
\end{Verbatim}
\end{tcolorbox}
